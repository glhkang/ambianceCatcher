...
const visuals = ["waveVisual", "barVisual"];
...
// window.addEventListener("click", selectVisual);
// function selectVisual() {
//   // visuals[Math.floor(Math.random() * visuals.length)];

//   console.log(
//     "YOU CHOSE YOUR VISUAL/BUTTON ONCLICK CLICKED",
//     visuals[Math.floor(Math.random() * visuals.length)]
//   );
// }
...
window.onload = function () {
  ...
  button.addEventListener("click", visualSelector);
  ...
  file.onchange = function () {
    ...
    function renderFrame() {
      ...
      if (visual === "barVisual") {
        ...
        console.log("sucka AND BARVISUAL");
